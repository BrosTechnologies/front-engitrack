...
import pe.edu.upc.engitrack.features.workers.data.repositories.WorkersRepositoryImpl
...
object RemoteModule {
    ...
    @Provides
    @Singleton
    fun provideWorkersRepository(workersRepositoryImpl: WorkersRepositoryImpl): WorkersRepository {
